...
- Include manual deployment scripts using gh-pages
...
echo "   git remote add origin https://github.com/george-shaji/portfolio.git"
echo "   git push -u origin main"
echo ""
echo "3. Deploy to GitHub Pages manually:"
echo "   npm run deploy"
echo ""
...
echo ""
echo "5. Your portfolio will be available at:"
echo "   https://george-shaji.github.io/portfolio"
echo ""
